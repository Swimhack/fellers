  ...
  return (
    <section className="section-padding bg-fellers-charcoal">
      <div className="container mx-auto">
        <h2 className="text-3xl md:text-4xl text-center mb-12 text-fellers-white">SERVICE AREA</h2>
        
        <div className="rounded-lg overflow-hidden shadow-2xl border-2 border-fellers-green/50 mb-6">
          <div className="aspect-ratio-16/9 h-[450px] w-full">
        ...
        <div className="text-center">
          <p className="text-lg text-fellers-white/80 max-w-3xl mx-auto">
