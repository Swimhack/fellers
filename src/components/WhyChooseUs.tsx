  ...
  return (
    <section id="why-choose-us" className="section-padding bg-black/30">
      <div className="container mx-auto">
        <h2 className="text-3xl md:text-4xl text-center mb-12 text-fellers-white gradient-bg text-transparent bg-clip-text">WHY CHOOSE US</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h3 className="text-2xl md:text-3xl mb-6 text-fellers-white">THE HEAVY-DUTY RECOVERY EXPERTS</h3>
            <p className="mb-6 text-lg text-fellers-white/80">
            ...
            <ul className="space-y-4">
              {reasons.map((reason, index) => (
                ...
                >
                  <div className="bg-fellers-green rounded-full p-1 mr-3">
                    <Check className="w-4 h-4 text-fellers-charcoal" />
                  </div>
                  <span className="text-fellers-white">{reason}</span>
                </li>
              ))}
            </ul>
          </div>
