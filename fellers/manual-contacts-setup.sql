-- Manual Contact Table Setup Script
...
-- Test the setup with a sample insert (optional)
-- You can uncomment and run this to test:
/*
INSERT INTO public.contacts (name, phone, email, location, details) 
VALUES ('Test Contact', '555-0123', 'test@example.com', 'Test Location', 'Test submission');
*/